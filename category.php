...
<div class="col-sm-12 text-center">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $id_cat = $row['cat_id'];
    ?>
        <a href='./category/<?= $id_cat ?>' class='btn btn-outline-dark m-2 <?php if ($_GET['category_id'] == $id_cat) echo "active"; ?>' id='<?= $id_cat ?>'>
    ...
    <div class="container">
        <div class="row">
            ...
            if (isset($_GET['category_id'])) {
                ...
                $the_id = $_GET['category_id'];
                if ($user['user_role'] == 'teacher') {
                    $teacher = $user['username'];
                    $query = "SELECT * from posts WHERE post_category_id ='$the_id' and post_status = 'published' and post_author='{$teacher}'";
                }
                else  $query = "SELECT * from posts WHERE post_category_id ='$the_id' and post_status = 'published'";
            ...
            ?>
                        ...
                        <div class="jumbotron">
                            <h1 class=""><?php callNameCategory($_GET['category_id']); ?></h1>
                        </div>
            ...
            <?php
                        ...
                        echo "<div class='alert alert-warning text-center col-sm-12'>No post was found.</div>";
                    }
                }
            }
