...
function MostreCalendario($mes)
{
    ...
    echo "<table border = '0' class='table' style='background-color:#dadada;' cellspacing = '0' align = 'center'>";
    echo "<tr>";
        ...
        for ($coluna = 0; $coluna < 7; $coluna++) {
            ...
            if ($diacorrente + 1 <= $numero_dias) {
                if ($coluna < $diasemana && $linha == 0) {
                    ...
                    echo "<a href = " . $_SERVER["PHP_SELF"] . "?month=$mes&day=" . ($diacorrente + 1) . ">" . ++$diacorrente . "</a>";
                }
            } else {
                break;
            }
